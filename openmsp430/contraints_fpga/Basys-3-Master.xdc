...
set_property IOSTANDARD LVCMOS33 [get_ports SEG_AN0]
set_property PACKAGE_PIN U4 [get_ports SEG_AN1]
set_property IOSTANDARD LVCMOS33 [get_ports SEG_AN1]
set_property PACKAGE_PIN V4 [get_ports SEG_AN2]
set_property IOSTANDARD LVCMOS33 [get_ports SEG_AN2]
set_property PACKAGE_PIN W4 [get_ports SEG_AN3]
set_property IOSTANDARD LVCMOS33 [get_ports SEG_AN3]
...
set_output_delay -clock [get_clocks sys_clk_pin] -max -add_delay 4.000 [get_ports SEG_D]
set_output_delay -clock [get_clocks sys_clk_pin] -min -add_delay 0.000 [get_ports SEG_E]
set_output_delay -clock [get_clocks sys_clk_pin] -max -add_delay 4.000 [get_ports SEG_E]
...
#set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets -of_objects [get_cells dut/frontend_0/mab[14]_INST_0_i_1]]
#set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets -of_objects [get_cells dut/frontend_0/mab[14]_INST_0]]
#set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets -of_objects [get_cells dut/mem_backbone_0/fe_mdb_in[15]_INST_0_i_1]]
